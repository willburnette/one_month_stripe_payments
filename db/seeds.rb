...
growth_hacking = Product.create(title: "Growth Hacking", 
		 ...
		 price: "4.99", sku: "GROHACK1", download_url: "https://s3.amazonaws.com/wmb-one-month-stripe-payments/Scan+Apr+22%2C+2015%2C+9_27+AM.pdf", details: "You'll get one video", description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p> 
...
growth_hacking_monthly = Product.create(title: "Growth Hacking Monthly", 
		 ...
		 price: "4.99", sku: "GROHACK2", download_url: "https://s3.amazonaws.com/wmb-one-month-stripe-payments/Scan+Apr+22%2C+2015%2C+9_27+AM.pdf", details: "We'll charge you monthly for unlimited access to our mentoring team", description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p> 
